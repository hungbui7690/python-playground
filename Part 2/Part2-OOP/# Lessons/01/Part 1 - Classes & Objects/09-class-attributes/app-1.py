...
~~ PI is the same in every instance. If we set PI as instance attribute, everytime we create new instance, it will stick to that instance. This will waste the memory.
